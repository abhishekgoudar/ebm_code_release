...
flags.DEFINE_string('dsprites_path',
    '/home/abhi/Documents/courses/UofT/CSC2506/project/data/data/dsprites-dataset/dsprites_ndarray_co1sh3sc6or40x32y32_64x64.npz',
    'path to dsprites characters')
flags.DEFINE_string('imagenet_datadir',  '//home/abhi/Documents/courses/UofT/CSC2506/project/data/imagenet_big', 'whether cutoff should always in image')
...
flags.DEFINE_string('imagenet_path', '/home/abhi/Documents/courses/UofT/CSC2506/project/data/imagenet', 'path to imagenet images')
...
class CelebA(Dataset):
    ...
    def __init__(self):
        self.path = "/home/abhi/Documents/courses/UofT/CSC2506/project/data/data/img_align_celeba"
...
class Cifar10(Dataset):
    def __init__(
        ...
        self.full = full
        self.data = CIFAR10(
            "/home/abhi/Documents/courses/UofT/CSC2506/project/data/cifar10",
            transform=transform,
            train=train,
            download=True)
...
class Cifar100(Dataset):
    def __init__(self, train=True, augment=False):
        ...
        self.data = CIFAR100(
            "/home/abhi/Documents/courses/UofT/CSC2506/project/data/cifar100",
            transform=transform,
            train=train,
            download=True)
...
class Svhn(Dataset):
    def __init__(self, train=True, augment=False):
        ...
        self.data = SVHN("/home/abhi/Documents/courses/UofT/CSC2506/project/data/svhn", transform=transform, download=True)
        self.one_hot_map = np.eye(10)
...
class Mnist(Dataset):
    def __init__(self, train=True, rescale=1.0):
        self.data = MNIST(
            "/home/abhi/Documents/courses/UofT/CSC2506/project/data/mnist",
            transform=transforms.ToTensor(),
